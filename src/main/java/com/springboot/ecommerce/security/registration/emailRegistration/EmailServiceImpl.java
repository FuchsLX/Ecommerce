...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendSimpleMail(EmailDetails details) {
        try {
            ...
            messageHelper.setText(details.getMessageBody(), true);
            messageHelper.setTo(details.getRecipient());
            messageHelper.setSubject(details.getSubject());
            messageHelper.setFrom("eshop27test@gmail.com");
    ...
    @Override
    public String buildVerifyEmail(String recipientName, String link){
